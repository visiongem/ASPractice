...
class DatePickerActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onClick(view: View?) {
        ...
        when(resId){
            ...
            R.id.btn_ok->{
                val date = String.format("您选择的日期是 ${mBinding.dpDate.year}年${mBinding.dpDate.month}月${mBinding.dpDate.dayOfMonth}日")
    ...
    override fun onDateSet(p0: DatePicker?, p1: Int, p2: Int, p3: Int) {
        val desc = String.format("您选择的日期是$p1 年$p2 月 $p3 日 ")
